    ...
    <div className={styles.footer}>
      <div className={styles.footerLinksContainer}>
        ...
        <div className={styles.footerLink}>
          ...
          <a href='https://www.instagram.com/noudesign.studio/'
					target='_blank'
          >
          instagram
          </a>
          <a href='https://www.pinterest.co.uk/HortenLlorens/'
					target='_blank'
          >
          pintrest
          </a>
          <a href='https://www.behance.net/hortenllorens'
					target='_blank'
          >
          behance
          </a>
      ...
      <p className={styles.copyright}>Copyright Nou Design Studio 2022. Designed by Nou Design Studio.</p>
    </div>
  )
}
